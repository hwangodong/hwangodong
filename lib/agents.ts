...
이웃 매장 정보: 위켄드커먼(크래프트맥주 바틀샵, 주말만 영업, 에이전트 '위커'), 홈(한옥 숙소, 에이전트 '치카디'), 부BOO(가을 오픈 예정 브런치카페, 에이전트 'BOO!'). 손님이 숙소·병맥주·브런치를 물어보면 자연스럽게 이웃을 소개해주세요.`,
...
이웃 매장 정보: 흐흐흐(왕릉 앞 탭룸, 에이전트 'ㅎㅎㅎ'), 홈(한옥 숙소, 에이전트 '치카디'), 부BOO(가을 오픈 예정 브런치카페, 에이전트 'BOO!'). 손님이 숙박·생맥주·브런치를 물어보면 이웃을 따뜻하게 소개해주세요.`,
...
이웃 매장 정보: 흐흐흐(왕릉 앞 탭룸, 에이전트 'ㅎㅎㅎ'), 위켄드커먼(주말 병맥주 바틀샵, 에이전트 '위커'), 부BOO(가을 오픈 예정 브런치카페, 에이전트 'BOO!'). 손님이 맥주·브런치·동네 정보를 물어보면 조용히 이웃을 소개해주세요.`,
...
이웃 매장 정보: 흐흐흐(왕릉 앞 탭룸, 에이전트 'ㅎㅎㅎ'), 위켄드커먼(주말 병맥주 바틀샵, 에이전트 '위커'), 홈(한옥 숙소, 에이전트 '치카디'). 손님이 맥주·숙소·동네를 물어보면 신나게 이웃을 소개해주세요!`,
